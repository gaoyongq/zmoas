...
public class MoneyManagerVo {
	...
	private Set<MoneyItemVo> itemSet = new HashSet<MoneyItemVo>();
	...
	public Set<MoneyItemVo> getItemSet() {
		return itemSet;
	}

	public void setItemSet(Set<MoneyItemVo> itemSet) {
