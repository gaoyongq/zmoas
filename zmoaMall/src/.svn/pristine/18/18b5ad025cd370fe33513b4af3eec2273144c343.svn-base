 ...
 *
 */
public class MoneyManagerResult {
	...
	private Set<MoneyItemResult> itemSet = new HashSet<MoneyItemResult>();
	//工作流状态
	...
	public Set<MoneyItemResult> getItemSet() {
		return itemSet;
	}

	public void setItemSet(Set<MoneyItemResult> itemSet) {
